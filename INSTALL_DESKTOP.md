...
- Installer ~1 MiB NSIS (`Gchat_1.3.14_x64-setup.exe`)
...
Download the GitHub Release for **v1.3.14**:

- **Windows:** `Gchat_1.3.14_x64-setup.exe`
...
`src-desktop-win/target/release/bundle/Gchat_1.3.14_x64-setup.exe`
