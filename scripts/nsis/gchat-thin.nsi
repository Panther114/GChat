...
Name "Gchat"
OutFile "..\..\src-desktop-win\target\release\bundle\Gchat_1.3.11_x64-setup.exe"
Unicode True
...
Section "Install"
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\Gchat" "DisplayName" "Gchat 1.3.11"
  ...
  WriteRegStr HKCU "Software\Microsoft\Windows\CurrentVersion\Uninstall\Gchat" "DisplayVersion" "1.3.11"
